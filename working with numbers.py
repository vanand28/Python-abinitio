...
print(3.14159)                                              #PRINTS ANY KIND OF NUMBER - INTEGER OR DECIMALS
print(-3.14159)                                             #ALSO IN NEGATIVE
print(10+4)                                                 #PERFORMING ADDITION
print(10*4)                                                 #PERFORMING MULTIPLICATION
print(10/4)                                                 #PERFORMING DIVISION
print(10//4)                                                #PERFORMING FLOOR DIVISION 10/4 = 2.5 -> 2
print(10%4)                                                 #MODULUS FXN - CALCULATES THE REMAINDER OF DIVISION
print(10**4)                                                #EXPONENT FXN - BASE**POWER
print(abs(-12))                                             #PRINTS ABSOLUTE VALUE

from math import *                                          #IMPORTING THE MATH MODULE
print(e)                                                    #CONSTANT - Euler's number
...
print(degrees(pi/4))                                        #CONVERT INTO DEGREES - degrees(radians)
print(radians(270))                                         #CONVERT INTO RADIANS - radians(degrees)
